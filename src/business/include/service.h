...
Patient *find_patient_by_uID(List_Patient *department_list, const char *username);
char *generate_hospital_identifier(const char *username, const char *department, List_Service_Provided *list_service_provided);
void generate_receipt(const char *uh_ID, List_Department *department_list, Patient *patient, List_Service_Provided *provided_service_list);
...
Service_Provided *find_service_by_username_ID(List_Service_Provided *head, const char *uhID);
