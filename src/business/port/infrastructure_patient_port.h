...
void add_payment_method_to_list(List_Payment_Method **payment_method_list, Payment_Method *method);
List_Payment_Method *create_payment_method_list(void);
Payment_Method *get_payment_method_by_username(List_Payment_Method *payment_method_list, const char *username);
