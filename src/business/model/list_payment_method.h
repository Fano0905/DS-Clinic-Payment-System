...
void save_new_payment_method(List_Payment_Method **head, Payment_Method *method);
Payment_Method *find_payment_method_by_username(List_Payment_Method *list, const char *username);
...
void delete_payment_method_by_username(List_Payment_Method **head, const char *username);
